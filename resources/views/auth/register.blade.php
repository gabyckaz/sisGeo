...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header bg-success text-white" style="text-align: center; font-weight: bold;">Formulario de Registro</div>
        <div class="card-body">
            ...
            {{ csrf_field() }}
              ...
              <div class="form-group row">
                <label for="TelefonoContacto" class="col-md-4 col-form-label text-md-right">{{ __('Telefono') }} *</label>
                  <div class="col-md-6">
                    <input type="tel" maxlength="10" class="form-control{{ $errors->has('TelefonoContacto') ? ' is-invalid' : '' }}" onkeypress="return filterInt(event,this);" name="TelefonoContacto" value="{{ old('TelefonoContacto') }}" required autofocus >
              ...
              <div class="form-group row">
                 <label for="Genero" class="col-md-4 col-form-label text-md-right">{{ __('Desea recibir notificaciones por email') }}</label>
                <div class="col-md-6">
                  <div class="form-check ">
                   <label class="form-check-label col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button type="submit" class="btn btn-success btn-block btn-flat"><strong>Registrarme</strong></button>
                </div>
              </div>
                <center><a href="{{ route('login') }}" class="text-center"><strong>¡Ya tengo una cuenta de usuario!</strong></a></center>
          </form>
        </div>
        <div class="card-footer text-muted">* Estos campos son obligatorios</div>
