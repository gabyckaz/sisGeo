                ...
                <label for="telefono" class="control-label">Telefono*</label>
                  <div class="input-group">
                   <div class="input-group-addon">
                    ...
                    <input type="text" maxlength="10" onkeypress="return filterInt(event,this);" name="TelefonoContacto" class="form-control"  id="telefono" value="{{ old('TelefonoContacto',$guia[0]->TelefonoContacto)}}" placeholder="Telefono">
                </div>
